...
class User extends Authenticatable
{
    ...
    private function getDefaultManufacturerColumns()
    {
        ...
        return [
            ...
            ['name' => 'Date Comments', 'order' => $order++, 'width' => 128, 'visible' => 1],
    ...
    private function getDefaultGenericColumns()
    {
        ...
        return [
            ...
            ['name' => 'Processes', 'order' => $order++, 'width' => 160, 'visible' => 1],
            ['name' => 'НПП/УДС', 'order' => $order++, 'width' => 84, 'visible' => 1],
            ['name' => 'Country', 'order' => $order++, 'width' => 144, 'visible' => 1],
            ['name' => 'Manufacturer', 'order' => $order++, 'width' => 140, 'visible' => 1],
            ['name' => 'Brand', 'order' => $order++, 'width' => 140, 'visible' => 1],
            ...
            ['name' => 'Minimum volume', 'order' => $order++, 'width' => 130, 'visible' => 1],
