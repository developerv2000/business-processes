...
class User extends Authenticatable
{
    ...
    private function getDefaultProcessColumns()
    {
        ...
        return [
            ...
            ['name' => 'PRICE 1', 'order' => $order++, 'width' => 72, 'visible' => 1],
            ['name' => 'PRICE 2', 'order' => $order++, 'width' => 72, 'visible' => 1],
            ['name' => 'Currency', 'order' => $order++, 'width' => 80, 'visible' => 1],
            ['name' => 'USD', 'order' => $order++, 'width' => 80, 'visible' => 1],
            ['name' => 'AGREED', 'order' => $order++, 'width' => 90, 'visible' => 1],
            ['name' => 'OUR PRICE 2', 'order' => $order++, 'width' => 100, 'visible' => 1],
            ['name' => 'OUR PRICE 1', 'order' => $order++, 'width' => 100, 'visible' => 1],
            ['name' => 'Price increased NEW PRICE', 'order' => $order++, 'width' => 186, 'visible' => 1],
            ['name' => 'Price increased by%', 'order' => $order++, 'width' => 156, 'visible' => 1],
            ['name' => 'Price increased THE DATE', 'order' => $order++, 'width' => 178, 'visible' => 1],

            ['name' => 'Shelf Life', 'order' => $order++, 'width' => 100, 'visible' => 1],
            ['name' => 'MOQ', 'order' => $order++, 'width' => 144, 'visible' => 1],

            ['name' => 'DOSSIER STATUS', 'order' => $order++, 'width' => 120, 'visible' => 1],
            ['name' => 'Year CR/BE', 'order' => $order++, 'width' => 90, 'visible' => 1],
            ['name' => 'Countries CR/BE', 'order' => $order++, 'width' => 120, 'visible' => 1],
            ['name' => 'Country ICH', 'order' => $order++, 'width' => 94, 'visible' => 1],
            ['name' => 'Zones', 'order' => $order++, 'width' => 60, 'visible' => 1],
            ...
            ['name' => 'Brand ENG', 'order' => $order++, 'width' => 90, 'visible' => 1],
            ['name' => 'Brand RUS', 'order' => $order++, 'width' => 90, 'visible' => 1],
            ['name' => 'Date of creation', 'order' => $order++, 'width' => 138, 'visible' => 1],
            ['name' => 'Update Date', 'order' => $order++, 'width' => 150, 'visible' => 1],
            ['name' => 'Product category', 'order' => $order++, 'width' => 158, 'visible' => 1],
            ['name' => 'ID', 'order' => $order++, 'width' => 90, 'visible' => 1],
    ...
    private function getDefaultKvppColumns()
    {
        ...
        return [
            ...
            ['name' => 'Coincident', 'order' => $order++, 'width' => 100, 'visible' => 1],
