...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $email = ['firdavs.kilichbekov@evolet.co.uk', 'olimjon.nuruloev@evolet.co.uk', 'shahriyor_p@evolet.co.uk', 'alim.munavarov@evolet.co.uk', ' bdm3@evolet.co.uk', 'behruz.muzaffar@outlook.com', 'bdm1@evolet.co.uk', 'irini@evolet.co.uk', 'farizmirzo@evolet.co.uk', 'firdavs.sirojov@evolet.co.uk', 'khudoydod.sharipov@evolet.co.uk', 'farrukh.kayumov@evolet.co.uk', 'bobnuridinov@gmail.com'];
